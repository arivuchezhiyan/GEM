            ...
            <div class="row">
                ...
                <div class="col-lg-3 order-lg-1">
                    ...
                    <div class="gem-sidebar-card gem-surgery-card">
                        <h5 class="gem-stats-title">
                            <i class="fa-solid fa-heart-pulse"></i> Cardiac Procedures
                        </h5>
                        <div class="gem-surgery-list">
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">01</span>
                                <span class="gsli-text">Coronary Angiography (Radial)</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">02</span>
                                <span class="gsli-text">Coronary Angioplasty &amp; Stenting</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">03</span>
                                <span class="gsli-text">Shockwave Lithotripsy (IVL)</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">04</span>
                                <span class="gsli-text">Rotablation for Calcified Lesions</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">05</span>
                                <span class="gsli-text">Pacemaker (PPI/AICD) Implantation</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">06</span>
                                <span class="gsli-text">ASD/VSD/PDA Device Closure</span>
                            </div>
                            <div class="gem-surgery-list-item gem-surgery-list-item--robotic">
                                <span class="gsli-num">07</span>
                                <span class="gsli-text">TAVI (Non-Surgical Valve Implantation)</span>
                            </div>
                            <div class="gem-surgery-list-item gem-surgery-list-item--robotic">
                                <span class="gsli-num">08</span>
                                <span class="gsli-text">Impella Supported High-Risk PCI</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="gem-sidebar-card gem-doctor-card">
                        ...
                        <p class="gem-doctor-bio">Renowned Senior Interventional Cardiologist with <strong>30+</strong> years of experience in safely performing complex cardiac procedures.</p>
                        <a href="doctor.php?id=dr-v-k-g-rajasekar" class="gem-sidebar-btn gem-sidebar-btn-outline">
