        ...
        <div class="container ptb--40">
            <div class="row">
                <div class="breadcrumb-area-wrapper">
                    <h1 class="title">Digestive Cancer Care</h1>
                    <div class="nav-bread-crumb">
                        <a href="/">Home</a>
                        <i class="fa-solid fa-chevron-right"></i>
                        <a href="#" class="current">Digestive Cancer Care</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="gem-sidebar-card gem-surgery-card">
                        ...
                        <div class="gem-surgery-list">
                            <div class="gem-surgery-list-item">
                                ...
                                <span class="gsli-text">Laparoscopic &amp; Robotic Whipple's</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">02</span>
                                <span class="gsli-text">Laparoscopic &amp; Robotic Esophagectomy</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">03</span>
                                <span class="gsli-text">Laparoscopic &amp; Robotic Gastrectomy</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">04</span>
                                <span class="gsli-text">Laparoscopic &amp; Robotic Hepatectomy</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">05</span>
                                <span class="gsli-text">Laparoscopic &amp; Robotic Colectomy</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">06</span>
                                <span class="gsli-text">Cytoreductive Surgery &amp; HIPEC</span>
                            </div>
                            <div class="gem-surgery-list-item gem-surgery-list-item--robotic">
                                <span class="gsli-num">07</span>
                                <span class="gsli-text">TAMIS / Transanal Microsurgery</span>
                            </div>
                            <div class="gem-surgery-list-item gem-surgery-list-item--robotic">
                                <span class="gsli-num">08</span>
                                <span class="gsli-text">Robotic Resection of GIST &amp; NET</span>
                            </div>
                        </div>
                    </div>
