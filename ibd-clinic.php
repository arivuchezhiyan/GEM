...
<head>
    ...
    <title>IBD Clinic | GEM Hospital Chennai - Esophago-Gastric Excellence</title>
        ...
        <div class="container ptb--40">
            <div class="row">
                <div class="breadcrumb-area-wrapper">
                    <h1 class="title">IBD Clinic</h1>
                    <div class="nav-bread-crumb">
                        <a href="/">Home</a>
                        <i class="fa-solid fa-chevron-right"></i>
                        <a href="#" class="current">IBD Clinic</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-9 pr--40 pr_md--10 pr_sm--15">
                    <div class="service-details-surgery-main">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="ugi-info-card">
                                    ...
                                    <ul class="ugi-card-list">
                                        ...
                                        <li><i class="fa-solid fa-circle-check"></i>Indeterminate Colitis</li>
                                        <li><i class="fa-solid fa-circle-check"></i>IBD-related Strictures</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Perianal Crohn's Disease</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Pouchitis Management</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="ugi-info-card ugi-info-card--green">
                                    <div class="ugi-info-card-head">
                                        ...
                                        <h5>Our Multi-modal Care</h5>
                                    </div>
                                    <ul class="ugi-card-list">
                                        <li><i class="fa-solid fa-circle-check"></i>Biological &amp; Biosimilar Therapy</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Minimally Invasive IBD Surgery</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Therapeutic Endoscopy</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Enteral &amp; Parenteral Nutrition</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Psychological Counseling</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Dedicated IBD Nursing Support</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="ugi-diag-grid">
                            ...
                            <div class="ugi-diag-card">
                                <div class="ugi-diag-icon"><i class="fa-solid fa-capsules"></i></div>
                        ...
                        <!-- GEM Advantage -->
                        <h3 class="title pt-5">The GEM IBD Advantage</h3>
                        <div class="ugi-surgery-timeline">
                            <div class="ugi-surgery-item">
                                <div class="ugi-surgery-num">01</div>
                                <div class="ugi-surgery-text">
                                    <strong>Dedicated IBD Team</strong>
                                    <p>A focused group of specialists with extensive experience in handling complex and refractory IBD cases.</p>
                                </div>
                            </div>
                            <div class="ugi-surgery-item ugi-surgery-item--accent">
                                <div class="ugi-surgery-num">02</div>
                                <div class="ugi-surgery-text">
                                    <strong>Small Bowel Expertise</strong>
                                    <p>One of the few centers in the region equipped with advanced enteroscopy for detailed small bowel assessment.</p>
                                </div>
                            </div>
                            <div class="ugi-surgery-item">
                                <div class="ugi-surgery-num">03</div>
                                <div class="ugi-surgery-text">
                                    <strong>Surgical Excellence</strong>
                                    <p>Expertise in laparoscopic and robotic IBD surgeries, including J-pouch procedures and stricturoplasty.</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="gem-sidebar-card gem-surgery-card">
                        <h5 class="gem-stats-title">
                            <i class="fa-solid fa-hand-holding-heart"></i> IBD Care &amp; Surgery
                        </h5>
                        <div class="gem-surgery-list">
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">01</span>
                                <span class="gsli-text">Laparoscopic Ileal Pouch Anal Anastomosis (IPAA)</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">02</span>
                                <span class="gsli-text">Total Proctocolectomy &amp; J-Pouch</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">03</span>
                                <span class="gsli-text">Laparoscopic Bowel Resection for Crohn's</span>
                            </div>
                            <div class="gsli-item-sub">
                                <div class="gem-surgery-list-item">
                                    <span class="gsli-num">04</span>
                                    <span class="gsli-text">Stricturoplasty for Small Bowel</span>
                                </div>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">05</span>
                                <span class="gsli-text">Biological Infusion Therapy</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">06</span>
                                <span class="gsli-text">Endoscopic Dilatation of Strictures</span>
                            </div>
                            <div class="gem-surgery-list-item gem-surgery-list-item--robotic">
                                <span class="gsli-num">07</span>
                                <span class="gsli-text">Robotic Colorectal Resection</span>
                            </div>
                            <div class="gem-surgery-list-item gem-surgery-list-item--robotic">
                                <span class="gsli-num">08</span>
                                <span class="gsli-text">Complex Fistula-in-Ano Management</span>
                            </div>
                        </div>
                    </div>
