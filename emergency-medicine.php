        ...
        <div class="container ptb--40">
            <div class="row">
                <div class="breadcrumb-area-wrapper">
                    <h1 class="title">Emergency Medicine</h1>
                    <div class="nav-bread-crumb">
                        <a href="/">Home</a>
                        <i class="fa-solid fa-chevron-right"></i>
                        <a href="#" class="current">Emergency Medicine</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="gem-sidebar-card gem-surgery-card">
                        <h5 class="gem-stats-title">
                            <i class="fa-solid fa-clock-rotate-left"></i> 24/7 Services
                        </h5>
                        <div class="gem-surgery-list">
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">01</span>
                                <span class="gsli-text">Emergency Abdomen Surgery</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">02</span>
                                <span class="gsli-text">GI Bleed Resuscitation</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">03</span>
                                <span class="gsli-text">Ambulance Retrieval Service</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">04</span>
                                <span class="gsli-text">Trauma &amp; Critical Care</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">05</span>
                                <span class="gsli-text">Emergency Dialysis Support</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">06</span>
                                <span class="gsli-text">Adult Immunization Wing</span>
                            </div>
                            <div class="gem-surgery-list-item gem-surgery-list-item--robotic">
                                <span class="gsli-num">07</span>
                                <span class="gsli-text">24/7 Radiology (CT/X-Ray)</span>
                            </div>
                            <div class="gem-surgery-list-item gem-surgery-list-item--robotic">
                                <span class="gsli-num">08</span>
                                <span class="gsli-text">24/7 Laboratory Services</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="gem-sidebar-card gem-doctor-card">
                        ...
                        <p class="gem-doctor-bio">Expert in emergency medicine and critical care management with extensive experience in leading life-saving ER protocols.</p>
