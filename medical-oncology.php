...
<head>
    ...
    <title>Medical Oncology | GEM Hospital Chennai - Esophago-Gastric Excellence</title>
        ...
        <div class="container ptb--40">
            <div class="row">
                <div class="breadcrumb-area-wrapper">
                    <h1 class="title">Medical Oncology</h1>
                    <div class="nav-bread-crumb">
                        <a href="/">Home</a>
                        <i class="fa-solid fa-chevron-right"></i>
                        <a href="#" class="current">Medical Oncology</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row g-4 mt--10">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="ugi-info-card">
                                    <div class="ugi-info-card-head">
                                        ...
                                        <h5>Medical Oncology may treat:</h5>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="ugi-info-card ugi-info-card--green">
                                    ...
                                    <ul class="ugi-card-list">
                                        <li><i class="fa-solid fa-circle-check"></i>Most advanced facilities for Medical Oncology</li>
