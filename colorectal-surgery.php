...
<head>
    ...
    <title>Colorectal Surgery | GEM Hospital Chennai - Esophago-Gastric Excellence</title>
        ...
        <div class="container ptb--40">
            <div class="row">
                <div class="breadcrumb-area-wrapper">
                    <h1 class="title">Colorectal Surgery</h1>
                    <div class="nav-bread-crumb">
                        <a href="/">Home</a>
                        <i class="fa-solid fa-chevron-right"></i>
                        <a href="#" class="current">Colorectal Surgery</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-9 pr--40 pr_md--10 pr_sm--15">
                    <div class="service-details-surgery-main">
                        ...
                        <h3 class="title pt-4">Conditions We Treat</h3>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="ugi-info-card">
                                    ...
                                    <ul class="ugi-card-list">
                                        <li><i class="fa-solid fa-circle-check"></i>Colon and Rectal Cancers</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Ulcerative Colitis &amp; Crohn’s Disease</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Rectal Prolapse</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Diverticulosis &amp; Diverticulitis</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Complex Abdominal Cancers</li>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="ugi-info-card ugi-info-card--green">
                                    <div class="ugi-info-card-head">
                                        ...
                                        <h5>Anorectal Disorders</h5>
                                    </div>
                                    <ul class="ugi-card-list">
                                        <li><i class="fa-solid fa-circle-check"></i>Haemorrhoids (Piles) - Laser Treatment</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Fistula-in-ano &amp; Fissure-in-ano</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Pilonidal Sinus (Laser/Flap)</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Anal Warts &amp; Pruritus Ani</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Constipation &amp; Incontinence</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Pelvic Floor Dysfunction</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="ugi-diag-grid">
                            ...
                            <div class="ugi-diag-card">
                                ...
                                <p>Video Proctoscopy</p>
                            </div>
                        </div>

                        <!-- Expertise & Recovery -->
                        <h3 class="title pt-5">The GEM Advantage</h3>
                        <div class="ugi-surgery-timeline">
                            <div class="ugi-surgery-item">
                                ...
                                <div class="ugi-surgery-text">
                                    ...
                                    <p>Advanced laser treatments for piles, fissures, and fistulas for minimal pain and bloodless surgery.</p>
                                </div>
                            </div>
                            <div class="ugi-surgery-item ugi-surgery-item--accent">
                                ...
                                <div class="ugi-surgery-text">
                                    ...
                                    <p>Superior visualization and precision in narrow pelvic surgery for rectal cancers.</p>
                                </div>
                            </div>
                            <div class="ugi-surgery-item">
                                <div class="ugi-surgery-num">03</div>
                                <div class="ugi-surgery-text">
                                    <strong>Dedicated Pelvic Floor Clinic</strong>
                                    <p>Specialized diagnostic lab for evaluating chronic constipation and fecal incontinence.</p>
                                </div>
                            </div>
                        </div>
