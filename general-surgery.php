...
<head>
    ...
    <title>General Surgery | GEM Hospital Chennai - Esophago-Gastric Excellence</title>
            ...
            <div class="row">
                <div class="col-lg-9 order-lg-2 pl--40 pl_md--10 pl_sm--15">
                    <div class="service-details-surgery-main">
                        ...
                        <div class="ugi-highlight-banner">
                            ...
                            <div>
                                <strong>Compassionate Precision</strong>
                                <p>We focus on minimally invasive techniques where possible, reducing post-operative pain and hospital stay, while providing comprehensive care for routine and complex conditions.</p>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="ugi-info-card">
                                    ...
                                    <ul class="ugi-card-list">
                                        <li><i class="fa-solid fa-circle-check"></i>Thyroid &amp; Parathyroid Surgery</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Breast Lumps &amp; Cancer Screening</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Diabetic Foot Management</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Sebaceous Cyst &amp; Lipoma Removal</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Abscess Drainage &amp; Wound Care</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Varicose Veins Management</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="ugi-info-card ugi-info-card--green">
                                    <div class="ugi-info-card-head">
                                        ...
                                        <h5>Advanced Care Modalities</h5>
                                    </div>
                                    <ul class="ugi-card-list">
                                        <li><i class="fa-solid fa-circle-check"></i>Day Care Surgery Procedures</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Minimally Invasive Techniques</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Advanced Laser Interventions</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Specialized Wound Care Unit</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Post-Op Pain Management</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Comprehensive Follow-up Care</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="ugi-diag-grid">
                            ...
                            <div class="ugi-diag-card">
                                <div class="ugi-diag-icon"><i class="fa-solid fa-laptop-medical"></i></div>
                                <p>Latest Technology</p>
                            </div>
                        </div>

                        <!-- GEM Advantage -->
                        <h3 class="title pt-5">Conditions Treated</h3>
                        <div class="ugi-surgery-timeline">
                            <div class="ugi-surgery-item">
                                ...
                                <div class="ugi-surgery-text">
                                    ...
                                    <p>Comprehensive management of thyroid nodules, goiters, and parathyroid abnormalities.</p>
                                </div>
                            </div>
                            <div class="ugi-surgery-item ugi-surgery-item--accent">
                                <div class="ugi-surgery-num">02</div>
                                <div class="ugi-surgery-text">
                                    <strong>Soft Tissue Lesions</strong>
                                    <p>Expert removal of various skin and soft tissue lumps including lipomas, cysts, and benign tumors.</p>
                                </div>
                            </div>
                            <div class="ugi-surgery-item">
                                <div class="ugi-surgery-num">03</div>
                                <div class="ugi-surgery-text">
                                    <strong>Chronic Wound Care</strong>
                                    <p>Specialized multidisciplinary care for diabetic foot ulcers and non-healing wounds.</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 order-lg-1">
                    ...
                    <div class="gem-sidebar-card gem-surgery-card">
                        <h5 class="gem-stats-title">
                            <i class="fa-solid fa-briefcase-medical"></i> Common Procedures
                        </h5>
                        <div class="gem-surgery-list">
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">01</span>
                                <span class="gsli-text">Thyroidectomy / Parathyroidectomy</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">02</span>
                                <span class="gsli-text">Breast Lump Excision / Surgery</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">03</span>
                                <span class="gsli-text">Diabetic Foot Surgery &amp; Care</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">04</span>
                                <span class="gsli-text">Lipoma &amp; Sebaceous Cyst Excision</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">05</span>
                                <span class="gsli-text">Incision &amp; Drainage of Abscess</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">06</span>
                                <span class="gsli-text">Hydrocele / Varicocele Repair</span>
                            </div>
                            <div class="gem-surgery-list-item gem-surgery-list-item--robotic">
                                <span class="gsli-num">07</span>
                                <span class="gsli-text">Varicose Veins Laser Therapy</span>
                            </div>
                            <div class="gem-surgery-list-item gem-surgery-list-item--robotic">
                                <span class="gsli-num">08</span>
                                <span class="gsli-text">Day Care Surgical Procedures</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="gem-sidebar-card gem-doctor-card">
                        <div class="gem-doctor-header">
                            <div class="gem-doctor-avatar">
                                <img src="assets/images/team/pinak-dasgupta.png" alt="Dr. Pinak Dasgupta">
                            </div>
                            <div class="gem-doctor-info">
                                <h5>Dr. Pinak Dasgupta</h5>
                                <span>Clinical Lead &amp; Head</span>
                            </div>
                        </div>
                        <p class="gem-doctor-bio">Expert in advanced general and laparoscopic surgery with a focus on holistic patient recovery and precise surgical outcomes.</p>
                        <a href="doctor.php?id=dr-pinak-dasgupta" class="gem-sidebar-btn gem-sidebar-btn-outline">
