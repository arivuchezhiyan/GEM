...
<head>
    ...
    <title>Multi- Organ Transplant | GEM Hospital Chennai - Esophago-Gastric Excellence</title>
        ...
        <div class="container ptb--40">
            <div class="row">
                <div class="breadcrumb-area-wrapper">
                    <h1 class="title">Multi- Organ Transplant</h1>
                    <div class="nav-bread-crumb">
                        <a href="/">Home</a>
                        <i class="fa-solid fa-chevron-right"></i>
                        <a href="#" class="current">Multi- Organ Transplant</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="service-details-surgery-main">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="ugi-info-card">
                                    ...
                                    <ul class="ugi-card-list">
                                        <li><i class="fa-solid fa-circle-check"></i>Deceased Donor Liver Transplant</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Live Donor Liver Transplant</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Pediatric Liver Transplant</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Auxiliary Liver Transplantation</li>
                                        <li><i class="fa-solid fa-circle-check"></i>ABO Incompatible Liver Transplant</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Domino Liver Transplantation</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="ugi-info-card ugi-info-card--green">
                                    <div class="ugi-info-card-head">
                                        ...
                                        <h5>Kidney &amp; Pancreas</h5>
                                    </div>
                                    <ul class="ugi-card-list">
                                        <li><i class="fa-solid fa-circle-check"></i>Laparoscopic Donor Nephrectomy</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Robotic Kidney Implantation</li>
                                        <li><i class="fa-solid fa-circle-check"></i>ABO Incompatible Kidney Transplant</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Dual Kidney Transplantation</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Pancreas Transplantation</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Simultaneous Kidney-Pancreas (SKP)</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="ugi-diag-grid">
                            ...
                            <div class="ugi-diag-card">
                                ...
                                <p>Dedicated Transplant ICU</p>
                            </div>
                            <div class="ugi-diag-card">
                                <div class="ugi-diag-icon"><i class="fa-solid fa-dna"></i></div>
                                <p>Advanced HLA/Crossmatch Lab</p>
                            </div>
                        </div>

                        <!-- Why choose GEM -->
                        <h3 class="title pt-5">The GEM Transplant Advantage</h3>
                        <div class="ugi-surgery-timeline">
                            <div class="ugi-surgery-item">
                                <div class="ugi-surgery-num">01</div>
                                <div class="ugi-surgery-text">
                                    <strong>Pioneering Expertise</strong>
                                    <p>First in India for Laparoscopic Living Donor Liver retrieval and global pioneer in Robotic kidney implantation.</p>
                                </div>
                            </div>
                            <div class="ugi-surgery-item ugi-surgery-item--accent">
                                ...
                                <div class="ugi-surgery-text">
                                    ...
                                    <p>All living donor retrievals are performed using laparoscopic or robotic techniques for faster donor recovery.</p>
                                </div>
                            </div>
                            <div class="ugi-surgery-item">
                                ...
                                <div class="ugi-surgery-text">
                                    ...
                                    <p>Multidisciplinary team providing lifelong follow-up, rehabilitation, and support for transplant recipients.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="gem-sidebar-card gem-surgery-card">
                        ...
                        <div class="gem-surgery-list">
                            <div class="gem-surgery-list-item">
                                ...
                                <span class="gsli-text">Laparoscopic Living Donor Liver Retrieval</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">02</span>
                                <span class="gsli-text">Liver Transplantation (Deceased &amp; Live)</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">03</span>
                                <span class="gsli-text">Laparoscopic Donor Nephrectomy</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">04</span>
                                <span class="gsli-text">Robotic Kidney Implantation</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">05</span>
                                <span class="gsli-text">ABO Incompatible (Mismatched) Transplant</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">06</span>
                                <span class="gsli-text">Pediatric Liver &amp; Kidney Transplant</span>
                            </div>
                            <div class="gem-surgery-list-item gem-surgery-list-item--robotic">
                                <span class="gsli-num">07</span>
                                <span class="gsli-text">Pancreas &amp; Simultaneous Kidney-Pancreas</span>
                            </div>
                            <div class="gem-surgery-list-item gem-surgery-list-item--robotic">
                                <span class="gsli-num">08</span>
                                <span class="gsli-text">Auxiliary &amp; Domino Liver Transplant</span>
                            </div>
                        </div>
                    </div>
