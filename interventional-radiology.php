...
<head>
    ...
    <title>Interventional Radiology | GEM Hospital Chennai - Esophago-Gastric Excellence</title>
        ...
        <div class="container ptb--40">
            <div class="row">
                <div class="breadcrumb-area-wrapper">
                    <h1 class="title">Interventional Radiology</h1>
                    <div class="nav-bread-crumb">
                        <a href="/">Home</a>
                        <i class="fa-solid fa-chevron-right"></i>
                        <a href="#" class="current">Interventional Radiology</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-9 order-lg-2 pl--40 pl_md--10 pl_sm--15">
                    <div class="service-details-surgery-main">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="ugi-info-card">
                                    ...
                                    <ul class="ugi-card-list">
                                        <li><i class="fa-solid fa-circle-check"></i>PTBD (Biliary Drainage)</li>
                                        <li><i class="fa-solid fa-circle-check"></i>TACE &amp; TARE (Cancer Therapy)</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Transjugular Liver Biopsy (TJLB)</li>
                                        <li><i class="fa-solid fa-circle-check"></i>TIPS &amp; DIPS Procedures</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Hepatic Vein Stenting</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Radiofrequency Ablation (RFA)</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="ugi-info-card ugi-info-card--green">
                                    <div class="ugi-info-card-head">
                                        ...
                                        <h5>General &amp; Advanced IR</h5>
                                    </div>
                                    <ul class="ugi-card-list">
                                        <li><i class="fa-solid fa-circle-check"></i>Percutaneous Nephrostomy</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Pancreatic Necrosis Drainage</li>
                                        <li><i class="fa-solid fa-circle-check"></i>CT-Guided Bone Biopsy</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Thyroid &amp; Lymph Node FNA</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Uterine Artery Embolization</li>
                                        <li><i class="fa-solid fa-circle-check"></i>IVC Filter Implantation</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="ugi-diag-grid">
                            ...
                            <div class="ugi-diag-card">
                                <div class="ugi-diag-icon"><i class="fa-solid fa-magnet"></i></div>
                                <p>High-Field MRI</p>
                            </div>
                            <div class="ugi-diag-card">
                                <div class="ugi-diag-icon"><i class="fa-solid fa-atom"></i></div>
                                <p>PET-CT Imaging</p>
                            </div>
                        </div>

                        <!-- GEM Advantage -->
                        <h3 class="title pt-5">The IR Advantage at GEM</h3>
                        <div class="ugi-surgery-timeline">
                            <div class="ugi-surgery-item">
                                <div class="ugi-surgery-num">01</div>
                                <div class="ugi-surgery-text">
                                    <strong>Pinhole Access</strong>
                                    <p>Most procedures are performed through a tiny skin puncture, eliminating the need for major incisions or sutures.</p>
                                </div>
                            </div>
                            <div class="ugi-surgery-item ugi-surgery-item--accent">
                                <div class="ugi-surgery-num">02</div>
                                <div class="ugi-surgery-text">
                                    <strong>Rapid Recovery</strong>
                                    <p>Patient recovery is significantly faster compared to traditional open surgery, often allowing same-day discharge.</p>
                                </div>
                            </div>
                            <div class="ugi-surgery-item">
                                <div class="ugi-surgery-num">03</div>
                                <div class="ugi-surgery-text">
                                    <strong>Multi-Disciplinary Support</strong>
                                    <p>Seamless collaboration with GI surgeons and oncologists to provide comprehensive care for complex cases.</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 order-lg-1">
                    ...
                    <div class="gem-sidebar-card gem-surgery-card">
                        <h5 class="gem-stats-title">
                            <i class="fa-solid fa-radiation"></i> IR Procedures
                        </h5>
                        <div class="gem-surgery-list">
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">01</span>
                                <span class="gsli-text">PTBD (Percutaneous Biliary Drainage)</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">02</span>
                                <span class="gsli-text">TACE / TARE for Liver Tumors</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">03</span>
                                <span class="gsli-text">TIPS / DIPS for Portal Hypertension</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">04</span>
                                <span class="gsli-text">Percutaneous Nephrostomy</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">05</span>
                                <span class="gsli-text">RFA (Radio Frequency Ablation)</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">06</span>
                                <span class="gsli-text">CT-Guided Biopsies (Bone/Liver/Lung)</span>
                            </div>
                            <div class="gem-surgery-list-item gem-surgery-list-item--robotic">
                                <span class="gsli-num">07</span>
                                <span class="gsli-text">Transjugular Liver Biopsy (TJLB)</span>
                            </div>
                            <div class="gem-surgery-list-item gem-surgery-list-item--robotic">
                                <span class="gsli-num">08</span>
                                <span class="gsli-text">Pancreatic Necrosis Drainage</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="gem-sidebar-card gem-doctor-card">
                        ...
                        <p class="gem-doctor-bio">Expert in diagnostic &amp; interventional radiology with specialized experience in complex image-guided procedures.</p>
                        <a href="doctor.php?id=dr-v-aravinda-narasimhan" class="gem-sidebar-btn gem-sidebar-btn-outline">
