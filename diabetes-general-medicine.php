...
<head>
    ...
    <title>Diabetes & General Medicine | GEM Hospital Chennai - Esophago-Gastric Excellence</title>
    ...
    <meta property="og:title" content="Diabetes & General Medicine Excellence | GEM Hospital Chennai">
    ...
    <meta property="og:image" content="https://gemhospital.net/chennai/assets/images/service/Diabetes%20%26%20General%20Medicine.png">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="https://gemhospital.net/chennai/upper-gi-surgery.php">
    <meta property="twitter:title" content="Diabetes & General Medicine Excellence | GEM Hospital Chennai">
    ...
    <meta property="twitter:image" content="https://gemhospital.net/chennai/assets/images/service/Diabetes%20%26%20General%20Medicine.png">
        ...
        <div class="container ptb--40">
            <div class="row">
                <div class="breadcrumb-area-wrapper">
                    <h1 class="title">Diabetes & General Medicine</h1>
                    <div class="nav-bread-crumb">
                        <a href="/">Home</a>
                        <i class="fa-solid fa-chevron-right"></i>
                        <a href="#" class="current">Diabetes & General Medicine</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-9 order-lg-2 pl--40 pl_md--10 pl_sm--15">
                    <div class="service-details-surgery-main">
                        <div class="thumbnail">
                            <img src="assets/images/service/Diabetes%20%26%20General%20Medicine.png" alt="Diabetes & General Medicine at GEM Hospital">
                        </div>
                        ...
                        <p class="disc">
                            GEM Hospital provides advanced diabetes and general medicine services for the diagnosis, treatment and management of chronic conditions and lifestyle-related disorders.
                        </p>
                        <p class="disc">
                            Our experienced physicians deliver personalized care using modern diagnostic tools, evidence-based treatment protocols and patient-centered approaches for long-term health and wellness.
                        </p>
                        ...
                        <div class="ugi-highlight-banner">
                            ...
                            <div>
                                ...
                                <p>GEM Hospital is the first in the world to perform Thoraco-Laparoscopic Esophagectomy
                                    in <em>'prone position'</em> for esophageal cancer — a technique now followed in
                                    most major centres across the globe.</p>
                            </div>
                        </div>

                        <p class="disc mt--20">
                            At GEM Hospital, our skilled surgeons ensure not only life-saving interventions for
                            conditions like esophageal, stomach, or pancreatic cancer but also an enhanced quality of
                            life for those dealing with GERD or peptic ulcer disease. Experience healthcare redefined at
                            GEM Hospital, where your well-being is our paramount priority.
                        </p>

                        <!-- Treat + Benefits: 2-col card grid -->
                        <div class="row g-4 mt--10">
                            <!-- Left Card: Conditions to treat -->
                            <div class="col-lg-6 col-md-6">
                                <div class="ugi-info-card">
                                    <div class="ugi-info-card-head">
                                        <span class="ugi-card-icon"><i class="fa-solid fa-stethoscope"></i></span>
                                        <h5>Diabetes & General Medicine may treat:</h5>
                                    </div>
                                    <ul class="ugi-card-list">
                                        <li><i class="fa-solid fa-circle-check"></i>Cancer of the esophagus, stomach, small intestine, or pancreas</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Gastroesophageal reflux disease (GERD)</li>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="ugi-info-card ugi-info-card--green">
                                    ...
                                    <ul class="ugi-card-list">
                                        <li><i class="fa-solid fa-circle-check"></i>Most advanced facilities for Diabetes & General Medicine</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Personalized treatment plan for every patient</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Committed to the safest possible care</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Expert team ready to guide you every step of the way</li>
                                        <li><i class="fa-solid fa-circle-check"></i>World-class robotic &amp; laparoscopic facilities</li>
