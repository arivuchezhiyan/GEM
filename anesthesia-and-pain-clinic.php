        ...
        <div class="container ptb--40">
            <div class="row">
                <div class="breadcrumb-area-wrapper">
                    <h1 class="title">Anesthesia And Pain Clinic</h1>
                    <div class="nav-bread-crumb">
                        <a href="/">Home</a>
                        <i class="fa-solid fa-chevron-right"></i>
                        <a href="#" class="current">Anesthesia And Pain Clinic</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 order-lg-1">
                    ...
                    <div class="gem-sidebar-card gem-surgery-card">
                        <h5 class="gem-stats-title">
                            <i class="fa-solid fa-syringe"></i> Clinic Services
                        </h5>
                        <div class="gem-surgery-list">
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">01</span>
                                <span class="gsli-text">Pre-operative Evaluation Clinic</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">02</span>
                                <span class="gsli-text">Acute Pain Service (APS)</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">03</span>
                                <span class="gsli-text">Chronic Pain Management</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">04</span>
                                <span class="gsli-text">Cancer Pain Interventions</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">05</span>
                                <span class="gsli-text">Spine &amp; Nerve Root Blocks</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">06</span>
                                <span class="gsli-text">Radiofrequency Ablation (RFA)</span>
                            </div>
                            <div class="gem-surgery-list-item gem-surgery-list-item--robotic">
                                <span class="gsli-num">07</span>
                                <span class="gsli-text">Labor Analgesia (Painless Labor)</span>
                            </div>
                            <div class="gem-surgery-list-item gem-surgery-list-item--robotic">
                                <span class="gsli-num">08</span>
                                <span class="gsli-text">Non-Operative Anesthesia (NORA)</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="gem-sidebar-card gem-doctor-card">
                        <div class="gem-doctor-header">
                            <div class="gem-doctor-avatar">
                                <img src="assets/images/team/vanmathy.png" alt="Dr. V. Vanmathy">
                            </div>
                        ...
                        <p class="gem-doctor-bio">Expert in advanced anesthesia techniques and chronic pain management with specialized training in USG-guided interventions.</p>
                        <a href="doctor.php?id=dr-v-vanmathy" class="gem-sidebar-btn gem-sidebar-btn-outline">
