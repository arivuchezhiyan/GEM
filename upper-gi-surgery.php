...
<head>
    ...
    <title>Upper GI Surgery | GEM Hospital Chennai - Esophago-Gastric Excellence</title>
    <meta name="description"
        content="GEM Hospital Chennai is one of India's most advanced centers for Upper GI diseases, specializing in laparoscopic and robotic surgery for esophageal and stomach cancers.">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://gemhospital.net/chennai/upper-gi-surgery.php">
    <meta property="og:title" content="Upper GI Surgery Excellence | GEM Hospital Chennai">
    <meta property="og:description"
        content="World-class care for Esophago-Gastric diseases. Pioneering Thoraco-Laparoscopic Esophagectomy techniques now used globally.">
    ...
    <meta property="twitter:title" content="Upper GI Surgery Excellence | GEM Hospital Chennai">
    ...
    <style>
        ...
        .gem-related-list li:last-child {
            border-bottom: none;
        }
        ...
        .ugi-surgery-item--accent:hover {
            border-left-color: #14a05a;
        }
        ...
        .ugi-surgery-item--accent .ugi-surgery-num {
            background: #14a05a;
        }
        ...
        <div class="container ptb--40">
            <div class="row">
                <div class="breadcrumb-area-wrapper">
                    <h1 class="title">Upper GI Surgery</h1>
                    <div class="nav-bread-crumb">
                        <a href="/">Home</a>
                        <i class="fa-solid fa-chevron-right"></i>
                        <a href="#" class="current">Upper GI Surgery</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-9 order-lg-2 pl--40 pl_md--10 pl_sm--15">
                    <div class="service-details-surgery-main">
                        <div class="thumbnail">
                            <img src="assets/images/service/10.webp" alt="Upper GI Surgery at GEM Hospital">
                        </div>

                        <!-- OVERVIEW -->
                        <h2 class="title">Advanced Centre for Gastrointestinal Disorders in India</h2>
                        <p class="disc">
                            GEM Hospital's <strong>Gastrointestinal Surgery Division</strong> is one of India’s top centres for treating complex GI disorders. We offer expert care in laparoscopic and robotic surgeries for conditions like cancer and GERD.
                        </p>
                        <p class="disc">
                        ...
                        <div class="row g-4 mt--10">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="ugi-info-card ugi-info-card--green">
                                    <div class="ugi-info-card-head">
                                        <span class="ugi-card-icon"><i class="fa-solid fa-shield-check"></i></span>
                                        <h5>Upper GI Surgery May Treat:</h5>
                                    </div>
                                    <ul class="ugi-card-list">
                                        <li><i class="fa-solid fa-circle-check"></i>Esophageal, Stomach, Small Intestine or Pancreatic Cancers</li>
                                        <li><i class="fa-solid fa-circle-check"></i>GERD (Gastroesophageal Reflux Disease)</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Hiatal Hernia</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Peptic Ulcer Disease</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Gallbladder Disorders</li>
                        ...
                        <div class="ugi-surgery-timeline">
                            <div class="ugi-surgery-item">
                                ...
                                <div class="ugi-surgery-text">
                                    <strong>Antireflux Procedures</strong>
                                    <p>Laparoscopic Nissen’s fundoplication and Redo Antireflux surgeries for GERD.</p>
                                </div>
                            </div>
                            <div class="ugi-surgery-item ugi-surgery-item--accent">
                                <div class="ugi-surgery-num">02</div>
                                <div class="ugi-surgery-text">
                                    <strong>Hernia Repairs</strong>
                                    <p>Laparoscopic repair of Hiatal and Paraesophageal Hernias.</p>
                                </div>
                            </div>
                            <div class="ugi-surgery-item">
                                <div class="ugi-surgery-num">03</div>
                                <div class="ugi-surgery-text">
                                    <strong>Motility Disorder Surgeries</strong>
                                    <p>Laparoscopic surgery for Achalasia Cardia and Redo-Heller’s Myotomy.</p>
                                </div>
                            </div>
                            <div class="ugi-surgery-item ugi-surgery-item--accent">
                                <div class="ugi-surgery-num">04</div>
                                <div class="ugi-surgery-text">
                                    <strong>Corrosive Injury Management</strong>
                                    <p>Complex Laparoscopic surgeries for corrosive esophago-gastric injuries.</p>
                                </div>
                            </div>
                            <div class="ugi-surgery-item">
                                <div class="ugi-surgery-num">05</div>
                                <div class="ugi-surgery-text">
                                    <strong>Cancer Surgeries</strong>
                                    <p>Robotic and Laparoscopic resection for Esophageal, Stomach, GIST, and NET tumors.
                                    </p>
                                </div>
                            </div>
                        </div> -->
                        ...
                        <div class="ugi-tag-grid">
                            ...
                            <span><i class="fa-solid fa-circle-dot"></i> Achalasia Cardia &amp; other motility disorders
                                of the esophagus</span>
                            <span><i class="fa-solid fa-circle-dot"></i> Corrosive esophago-gastric injuries (acid /
                                alkali ingestion)</span>
                ...
                <div class="col-lg-3 order-lg-1">
                    ...
                    <div class="gem-sidebar-card gem-doctor-card">
                        ...
                        <p class="gem-doctor-bio">World-renowned pioneer in laparoscopic &amp; robotic surgery with
                            <strong>1000+</strong> esophageal cancer surgeries performed successfully.</p>
