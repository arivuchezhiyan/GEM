...
<head>
    ...
    <title>Laparoscopic Hernia Surgery | GEM Hospital Chennai - Low Recurrence Rate</title>
    <meta name="description"
        content="GEM Hospital Chennai specializes in advanced laparoscopic hernia surgery with unprecedentedly low recurrence rates. Expert care for complex incisional and ventral hernias.">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://gemhospital.net/chennai/hernia.php">
    ...
    <meta property="twitter:url" content="https://gemhospital.net/chennai/hernia.php">
        ...
        <div class="container ptb--40">
            <div class="row">
                <div class="breadcrumb-area-wrapper">
                    <h1 class="title">Hernia Surgery</h1>
                    <div class="nav-bread-crumb">
                        <a href="/">Home</a>
                        <i class="fa-solid fa-chevron-right"></i>
                        <a href="#" class="current">Hernia Surgery</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-9 order-lg-2 pl--40 pl_md--10 pl_sm--15">
                    <div class="service-details-surgery-main">
                        ...
                        <!-- OVERVIEW -->
                        <h2 class="title">Hernia Speciality Content</h2>
                        <p class="disc">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="ugi-info-card">
                                    <div class="ugi-info-card-head">
                                        ...
                                        <h5>Excellence in Hernia Care</h5>
                                    </div>
                                    <ul class="ugi-card-list">
                                        ...
                                        <li><i class="fa-solid fa-circle-check"></i>Advanced Operation Facilities</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Dedicated Recovery Support</li>
                                        <li><i class="fa-solid fa-circle-check"></i>Trusted Clinical Expertise</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                        ...
                        <!-- GEM Advantage -->
                        <h3 class="title pt-5">The GEM Advantage in Hernia Repair</h3>
                ...
                <div class="col-lg-3 order-lg-1">
                    ...
                    <div class="gem-sidebar-card gem-doctor-card">
                        ...
                        <p class="gem-doctor-bio">World-renowned pioneer in laparoscopic &amp; robotic surgery with
                            <strong>1000+</strong> hernia and minimally invasive surgeries performed successfully.</p>
