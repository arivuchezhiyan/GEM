...
(function ($) {
  ...
  var rtsJs = {
    ...
    swiperActive: function () {
      ...
      $(document).ready(function () {
        var swiper = new Swiper(".mySwiper-banner-mobile", {
          spaceBetween: 0,
          slidesPerView: 1,
          loop: true,
          speed: 2000,
      ...
      $(document).ready(function () {
        var swiper = new Swiper(".specialities-swiper-container", {
          spaceBetween: 30,
          slidesPerView: 4,
          loop: true,
          speed: 1000,
      ...
      $(document).ready(function () {
        var swiper = new Swiper(".gem-testimonial-swiper", {
          spaceBetween: 30,
          slidesPerView: 1,
          loop: true,
          speed: 800,
