            ...
            <div class="row">
                <div class="breadcrumb-area-wrapper">
                    ...
                    <div class="nav-bread-crumb">
                        ...
                        <a href="#" class="current">Urology</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 order-lg-1">
                    ...
                    <div class="gem-sidebar-card gem-surgery-card">
                        <h5 class="gem-stats-title">
                            <i class="fa-solid fa-user-shield"></i> Urology Procedures
                        </h5>
                        <div class="gem-surgery-list">
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">01</span>
                                <span class="gsli-text">Laser Lithotripsy for Kidney Stones (RIRS/PCNL)</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">02</span>
                                <span class="gsli-text">Holmium Laser Enucleation of Prostate (HoLEP)</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">03</span>
                                <span class="gsli-text">Laparoscopic Pyeloplasty &amp; Nephrectomy</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">04</span>
                                <span class="gsli-text">Urethral Reconstruction (Urethroplasty)</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">05</span>
                                <span class="gsli-text">Incontinence Surgery (Slings/TVT)</span>
                            </div>
                            <div class="gem-surgery-list-item">
                                <span class="gsli-num">06</span>
                                <span class="gsli-text">Varicocele Repair &amp; Male Infertility Care</span>
                            </div>
                            <div class="gem-surgery-list-item gem-surgery-list-item--robotic">
                                <span class="gsli-num">07</span>
                                <span class="gsli-text">Robotic Radical Prostatectomy</span>
                            </div>
                            <div class="gem-surgery-list-item gem-surgery-list-item--robotic">
                                <span class="gsli-num">08</span>
                                <span class="gsli-text">Robotic Partial/Radical Nephrectomy</span>
                            </div>
                        </div>
                    </div>
